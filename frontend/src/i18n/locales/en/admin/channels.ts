export default {
    ...
    riskControl: {
      ...
      blocks: {
        title: 'Active session blocks',
        hint: 'Identities that hit a hard upstream block and are now rejected locally until their TTL expires. Unblock to let them through again immediately.',
        empty: 'No identity is currently blocked.',
        identity: 'Identity',
        kind: 'Matched by',
        signal: 'Signal',
        blockedAt: 'Blocked at',
        expiresAt: 'Auto-expires',
        actions: 'Actions',
        unblock: 'Unblock',
        unblockSuccess: 'Identity unblocked',
        unblockFailed: 'Failed to unblock identity',
        loadFailed: 'Failed to load active blocks',
        kinds: {
          xUserIdSession: 'End user + session',
          xUserId: 'End user (X-User-Id)',
          session: 'Session',
          apikeyUser: 'API key + user (whole key)',
          unknown: 'Unspecified',
        },
        signals: {
          refusal: 'Hard refusal (stop_reason)',
