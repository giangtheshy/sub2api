...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	claudeWebClient := repository.NewClaudeWebClient()
	...
	accountTestService := service.ProvideAccountTestService(accountRepository, geminiTokenProvider, claudeTokenProvider, grokTokenProvider, antigravityGatewayService, httpUpstream, configConfig, tlsFingerprintProfileService, openAIGatewayService, settingService, claudeWebClient)
	...
	claudeCookieAccountService := service.NewClaudeCookieAccountService(proxyRepository, claudeWebClient)
	oAuthHandler := admin.NewOAuthHandler(oAuthService, claudeCookieAccountService)
	...
	contentModerationHandler := admin.NewContentModerationHandler(contentModerationService, openAIGatewayService)
