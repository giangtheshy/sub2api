...
func TestClassifyNoAccountError_NilDiagnoser_Falls503(t *testing.T) {
	...
	cls := classifyNoAccountErrorFromGin(c, nil, apiKey, "gpt-5", "gpt-5", service.PlatformOpenAI, err)
...
func TestClassifyNoAccountError_NilAPIKey_Falls503(t *testing.T) {
	...
	cls := classifyNoAccountErrorFromGin(c, fd, nil, "gpt-5", "gpt-5", service.PlatformOpenAI, err)
...
func TestClassifyNoAccountError_NilGroupID_Falls503(t *testing.T) {
	...
	cls := classifyNoAccountErrorFromGin(c, fd, apiKey, "gpt-5", "gpt-5", service.PlatformOpenAI, err)
...
func TestClassifyNoAccountError_EmptyModel_Falls503(t *testing.T) {
	...
	cls := classifyNoAccountErrorFromGin(c, fd, apiKey, "   ", "", service.PlatformOpenAI, err)
...
func TestClassifyNoAccountError_ModelNotSupported_Returns404(t *testing.T) {
	...
	cls := classifyNoAccountErrorFromGin(c, fd, apiKey, "gpt-5.1-codex-mini", "gpt-5.1-codex-mini", service.PlatformOpenAI, err)
...
func TestClassifyOpenAICompatibleNoAccountError_GrokUsesGrokPlatform(t *testing.T) {
	...
	cls := classifyOpenAICompatibleNoAccountErrorFromGin(c, fd, apiKey, "grok-4.5", "grok-4.5", err)
...
func TestClassifyNoAccountError_ModelSupportedOnlyByRateLimitedAccount_Returns503(t *testing.T) {
	...
	cls := classifyNoAccountErrorFromGin(c, fd, apiKey, "claude-opus-4-8", "claude-opus-4-8", service.PlatformAnthropic, err)
...
func TestClassifyNoAccountError_DisplayModelOverridesRoutingForMessage(t *testing.T) {
	...
	cls := classifyNoAccountErrorFromGin(c, fd, apiKey, "gpt-5", "claude-3-fancy", service.PlatformOpenAI, err)
...
func TestClassifyNoAccountError_FromGin_NilContextStillSafe(t *testing.T) {
	...
	cls := classifyNoAccountErrorFromGin(nil, fd, apiKey, "gpt-5", "gpt-5", service.PlatformOpenAI, err)
